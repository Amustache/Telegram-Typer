...
def update_cooldown_and_notify(player_id: int, players_instance, context: CallbackContext) -> int:
...
def set_cooldown(player_id: int, players_instance, COUNTER_LIMIT=10_000) -> None:
